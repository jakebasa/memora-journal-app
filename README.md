...
_Clean, intuitive dashboard with quick actions and recent entries_

### Rich Text Editor

![New Entry](./screenshots/new-entry.png)
_Powerful rich text editor with AI writing prompts and mood tracking_

### Analytics & Insights

![Analytics](./screenshots/insights.png)
_Comprehensive analytics with mood distribution, writing streaks, and AI-powered insights_

### Browse & Search

![Browse Entries](./screenshots/browse-entries.png)
_Advanced search and filtering with responsive card layout_

### AI-Powered Features

![AI Chat](./screenshots/ai-chat.png)
_Context-aware AI assistant with access to your journal entries_

### Theme Customization

![Themes](./screenshots/themes.png)
_6 beautiful color themes with light/dark mode support_
